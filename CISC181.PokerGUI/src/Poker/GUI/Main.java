...
public class Main extends JFrame implements Client {
	...
	private void initialize() {
		...
		mnGameType.add(rdbtnmntmCardJoker);
		
		JRadioButtonMenuItem rdbtnmntmCardStud = new JRadioButtonMenuItem("5 Card Stud");
		mnGameType.add(rdbtnmntmCardStud);
		
		JRadioButtonMenuItem rdbtnmntmCard2Joker = new JRadioButtonMenuItem("5 Card 2 Joker");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
			}
		});
		mnGameType.add(rdbtnmntmCard2Joker);
		
		JRadioButtonMenuItem texasHoldEm = new JRadioButtonMenuItem("Texas HoldEm");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//restart the game!
			}
		});
		mnGameType.add(texasHoldEm);
		
		JRadioButtonMenuItem omaha = new JRadioButtonMenuItem("Omaha");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//
			}
		});
		mnGameType.add(omaha);
		
		JRadioButtonMenuItem sevenDraw = new JRadioButtonMenuItem("Seven Draw");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//restart the game!
			}
		});
		mnGameType.add(sevenDraw);
		
		JRadioButtonMenuItem deucesWild = new JRadioButtonMenuItem("Deuces Wild");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//restart the game!
			}
		});
		mnGameType.add(deucesWild);
		
		JRadioButtonMenuItem acesAndEights = new JRadioButtonMenuItem("Aces and Eights");
		rdbtnmntmCardJoker.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//restart the game!
			}
		});
		mnGameType.add(acesAndEights);
		
		ButtonGroup menuGroup = new ButtonGroup();
		menuGroup.add(rdbtnmntmCardStud);
		menuGroup.add(rdbtnmntmCardJoker);
		menuGroup.add(rdbtnmntmCard2Joker);
		menuGroup.add(texasHoldEm);
		menuGroup.add(omaha);
		menuGroup.add(sevenDraw);
		menuGroup.add(deucesWild);
		menuGroup.add(acesAndEights);
